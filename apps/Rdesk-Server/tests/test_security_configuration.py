...
class SecurityConfigurationCompatibilityTests(unittest.TestCase):
    """Keep the original backend configuration contract covered as well."""
    ...
    def test_production_accepts_explicit_secrets(self) -> None:
        ...
        self.assertEqual(configured.jwt_expire_minutes, 60)
    ...
    def test_web_topology_uses_distinct_default_ports(self) -> None:
        ...
        self.assertEqual(configured.server_port, 9530)
